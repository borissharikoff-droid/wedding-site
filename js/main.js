...
(function () {
  ...
  var FAQ = [
    ...
    ['А дресс-код какой-то есть?',
     'Есть — цвета из нашей палитры (мягкие или яркие, на выбор). А в остальном: нарядно, но чтобы не жалко было танцевать.'],
    ...
    ['Детей брать можно?',
     'Мы детей обожаем, но этот вечер решили провести во взрослой компании. Так что малышей, увы, не будет.'],
    ['До какого числа тянуть с анкетой?',
     'Не позже чем за месяц до дня Х — то есть до 8 августа 2026 года. Дальше не ждём.'],
    ['Что там с подарками?',
     'Больше всего обрадуемся конверту с деньгами, но и любому знаку внимания скажем спасибо от души.'],
    ['Фоткать можно?',
     'Конечно, доставайте телефоны! Только на самой церемонии просим убрать — красивые кадры сделают профессионалы.'],
    ['А если планы поменяются после анкеты?',
     'Пишите нам в Telegram (@Chillyteen или @CommercialPunk) — перерешаем и всё поправим, не проблема.']
  ];
